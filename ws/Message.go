...
type Message struct {
	...
	PushHandler func (manager *ClientManager)
}
...
func (message *Message) DefaultPushHandler(manager *ClientManager) {
	switch message.Type {
...
func (message *Message) SetPushHandler (handler func(manager *ClientManager)()) {
